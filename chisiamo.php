...
?>
  ...
  <body onload="setTimeout('init();', 100);">
	...
	<div><br/></div>
	<div class="alert alert-info" role="alert">Chi siamo</div>
		...
		<div class="row">
			<div class="col-sm-6 col-md-4">
				<div class="thumbnail">
					...
					<div class="caption">
						<h3>Andrea Merlin</h3>
						<p>Laureato in Informatica. Appassionato di sviluppo software. Da sempre in Val Borbera!</p>
						<p><a href="http://andreamerlin.keantex.com">Il suo blog</a></p>
					</div>
				</div>
			</div>
			...
			<div class="col-sm-6 col-md-4">
				<div class="thumbnail">
					...
					<div class="caption">
						<h3>Davide Bergantin</h3>
						<p>Appassionato di Tecnlogia e di Genealogia. Da sempre in Val Borbera!</p>
						<p><br/></p>
					</div>
				</div>
			</div>
			...
			<div class="col-sm-6 col-md-4">
				<div class="thumbnail">
					...
					<div class="caption">
						<h3>Andrea Franzante</h3>
						<p>Da sempre in Val Borbera!</p>
						<p><br/><br/></p>
					</div>
				</div>
			</div>
